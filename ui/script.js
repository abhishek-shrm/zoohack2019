...
$('#myModal1').on('show.bs.modal',function(event){
  ...
  modal.find('#products-table-1 tbody').html(rows.join(''));
});
...
$('#myModal2').on('show.bs.modal',function(event){
  ...
  modal.find('#products-table-2 tbody').html(rows.join(''));
});
//Modal 3
$('#myModal3').on('show.bs.modal',function(event){
  ...
  modal.find('#products-table-3 tbody').html(rows.join(''));
});
//Modal 4
$('#myModal4').on('show.bs.modal',function(event){
  ...
  modal.find('#products-table-4 tbody').html(rows.join(''));
});
...
$('#myModal5').on('show.bs.modal',function(event){
  ...
  modal.find('#products-table-5 tbody').html(rows.join(''));
});